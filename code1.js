...
gdjs.Loading2Code.asyncCallback31103764 = function (runtimeScene, asyncObjectsList) {
...
gdjs.Loading2Code.idToCallbackMap.set(31103764, gdjs.Loading2Code.asyncCallback31103764);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.5), (runtimeScene) => (gdjs.Loading2Code.asyncCallback31103764(runtimeScene, asyncObjectsList)), 31103764, asyncObjectsList);
}
}
...
};gdjs.Loading2Code.asyncCallback31108004 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.Loading2Code.localVariables);
...
gdjs.Loading2Code.idToCallbackMap.set(31108004, gdjs.Loading2Code.asyncCallback31108004);
...
const asyncObjectsList = new gdjs.LongLivedObjectsList();
asyncObjectsList.backupLocalVariablesContainers(gdjs.Loading2Code.localVariables);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(2), (runtimeScene) => (gdjs.Loading2Code.asyncCallback31108004(runtimeScene, asyncObjectsList)), 31108004, asyncObjectsList);
}
}
...
};gdjs.Loading2Code.asyncCallback31112132 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.Loading2Code.localVariables);
{gdjs.evtTools.runtimeScene.pushScene(runtimeScene, "MainScene5");
}
gdjs.Loading2Code.localVariables.length = 0;
}
gdjs.Loading2Code.idToCallbackMap.set(31112132, gdjs.Loading2Code.asyncCallback31112132);
...
asyncObjectsList.backupLocalVariablesContainers(gdjs.Loading2Code.localVariables);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(2), (runtimeScene) => (gdjs.Loading2Code.asyncCallback31112132(runtimeScene, asyncObjectsList)), 31112132, asyncObjectsList);
}
}
...
};gdjs.Loading2Code.asyncCallback31111036 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.Loading2Code.localVariables);
...
gdjs.Loading2Code.idToCallbackMap.set(31111036, gdjs.Loading2Code.asyncCallback31111036);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1), (runtimeScene) => (gdjs.Loading2Code.asyncCallback31111036(runtimeScene, asyncObjectsList)), 31111036, asyncObjectsList);
}
}
...
};gdjs.Loading2Code.asyncCallback31110940 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.Loading2Code.localVariables);
...
gdjs.Loading2Code.idToCallbackMap.set(31110940, gdjs.Loading2Code.asyncCallback31110940);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.1), (runtimeScene) => (gdjs.Loading2Code.asyncCallback31110940(runtimeScene, asyncObjectsList)), 31110940, asyncObjectsList);
}
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(31110340);
}
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(31103868);
}
}
if (isConditionTrue_0) {
